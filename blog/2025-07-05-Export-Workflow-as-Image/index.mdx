...
authors: [zhangli]
tags: [workflow automation, OOMOL, container, export image]
date: 2025-07-05
description: "Learn how to export an OOMOL workflow as an OCI image, deploy it as a background service, and run a PDF-to-EPUB translation pipeline anywhere."
image: /img/blogs/2025-07-05-Export-Workflow-as-Image/flow.png
---
...
After obtaining the image file, use a container runtime command such as `docker` to load it. In the terminal, run
...
For detailed interface descriptions, refer to the API schema exposed at `http://localhost:3000/ui`.
