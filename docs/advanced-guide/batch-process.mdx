...
If you want the reusable design patterns behind these blocks, including `some`, `every`, and reducer-style variants, see [Subflow Recipes](/docs/advanced-guide/subflow-recipes).
