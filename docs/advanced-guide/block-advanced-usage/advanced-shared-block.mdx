...
Since the [Node.js preview](/docs/workflow-engine/nodejs-sdk-api#3-contextpreview-types) / [Python preview](/docs/workflow-engine/nodejs-sdk-api#3-contextpreview-types) functionality provided by OOMOL Studio has limited scenarios, we provide custom UI to let users decide what content the Block can render or preview.
