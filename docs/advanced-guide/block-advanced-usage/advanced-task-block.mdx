...
The Task Block configuration is consistent with [Universal Block Settings](/docs/advanced-guide/block-advanced-usage/universal-block-settings) except for the `Custom UI`.
