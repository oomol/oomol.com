...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-number.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-number.png"
    ),
...
After selecting color type, you can use color selection controls in the data input field. In sub-configuration items, we provide `HEX8` / `HSV` / `RGB` three color format options.
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-jsonschema.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-jsonschema.png"
    ),
