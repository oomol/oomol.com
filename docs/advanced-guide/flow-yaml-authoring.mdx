...
For authoring rules about secrets, OOMOL auth, Fusion-first decisions, and `sessionDir` fallback patterns, see [Secrets, Auth, and Runtime Paths](/docs/advanced-guide/secrets-auth-and-runtime-paths).
