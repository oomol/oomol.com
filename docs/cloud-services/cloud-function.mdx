...
[CLI guide](/docs/cloud-services/cli). If you need the concrete CLI namespaces
and commands, use the
[Command Reference](/docs/cloud-services/cli-command-reference). If you need to
...
See the [CLI guide](/docs/cloud-services/cli) for the recommended workflow and
the [Command Reference](/docs/cloud-services/cli-command-reference) for current
commands such as `oo search`, `oo packages info`, and `oo cloud-task run`.
...
[CLI guide](/docs/cloud-services/cli). Cloud Function currently uses the
`Cloud Task v3` integration layer for direct API access. For the current CLI
command surface, see the
[Command Reference](/docs/cloud-services/cli-command-reference). For a working
request example, see
...
- [CLI Command Reference](/docs/cloud-services/cli-command-reference)
