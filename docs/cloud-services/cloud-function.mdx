...
If you need to call Cloud Function programmatically, use the docs in **API & SDK**. The current execution endpoints and packages still use the name `Cloud Task v3`, but they are the integration layer behind Cloud Function.
