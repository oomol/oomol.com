...
If you want to use a published OOMOL function from Codex, Claude Code, or a regular terminal session, start with the [CLI guide](/docs/cloud-services/cli). This page covers the lower-level programmatic integration layer.
...
| --- | --- | --- |
| [CLI](/docs/cloud-services/cli) | Codex, Claude Code, terminal usage, and individual users who want the simplest path | `bun install -g @oomol-lab/oo-cli` |
