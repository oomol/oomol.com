...
| --- | --- | --- |
| [oo-cli](/docs/oo-cli) | Codex, Claude Code, terminal usage, mixed package and connector discovery, and individual users who want the simplest path | `curl -fsSL https://cli.oomol.com/install.sh \| bash` |
