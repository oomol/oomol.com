...
In the lower left corner is the [OOMOL Credits](/docs/get-started/metering-and-billing) information for your current account, where you can see the usage and remaining quantity of your Credits, as well as access the Credits management page.
...
:::info
"Disk" is a concept in OOMOL Studio that represents the storage mount point of a virtual machine. It is similar to a container volume.
:::
