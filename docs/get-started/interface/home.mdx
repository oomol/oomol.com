...
> To ensure compatibility across different systems, we require that the "Container Dir Name" must start with a lowercase letter + array and can only include: lowercase letters, numbers, dots, underscores, and hyphens, with a maximum of 215 characters.
