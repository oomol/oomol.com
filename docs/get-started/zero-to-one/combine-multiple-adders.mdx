...
<ThemedResponsiveVideo
  lightSrc="/img/docs/get-started/zero-to-one/scriptlet-to-task-block-light.mp4"
  darkSrc="/img/docs/get-started/zero-to-one/scriptlet-to-task-block-dark.mp4"
  type="video/mp4"
  muted
  autoPlay
  loop
...
Once the conversion is complete, you will notice that the newly converted task block appears in the left [Shared Blocks](/docs/concepts/block#shared-block).
...
<div className="image-container">
  <ThemedResponsiveVideo
    lightSrc="/img/docs/get-started/zero-to-one/task-block-in-workflow-multiple-light.mp4"
    darkSrc="/img/docs/get-started/zero-to-one/task-block-in-workflow-multiple-dark.mp4"
    type="video/mp4"
    muted
    autoPlay
    loop
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/get-started/zero-to-one/mutiple-task-block-combination-run-light.webp"
    ),
    dark: useBaseUrl(
      "/img/docs/get-started/zero-to-one/mutiple-task-block-combination-run-dark.webp"
    )
  }}
/>
