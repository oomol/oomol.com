...
<div className="docs-overview-hero">
  <div className="docs-overview-copy">
    <div className="docs-overview-kicker">Do first. Read later.</div>
    <div className="docs-overview-title">
      Have a question? Ask Agent.<br />
      Have a task? Let Agent do it.
    </div>
    <div className="docs-overview-lead">
      Open the docs only when you need exact details.
    </div>

    <div className="docs-overview-quick-actions">
      <div className="docs-overview-quick-action">
        <span className="docs-overview-quick-label">Need help</span>
        <strong>Ask Agent directly</strong>
        <div className="docs-overview-quick-copy">
          Let it tell you the next step.
        </div>
      </div>
      <div className="docs-overview-quick-action">
        <span className="docs-overview-quick-label">Know the goal</span>
        <strong>Let Agent execute</strong>
        <div className="docs-overview-quick-copy">
          Let it build the workflow and handle the edits.
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="docs-overview-video-card">
    <div className="docs-overview-video-header">
      ...
      <small>Watch first. Read later if needed.</small>
    </div>
    <video
