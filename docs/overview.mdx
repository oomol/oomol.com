...
## Build With Fusion SDK

If you want to turn an OOMOL-hosted capability into a reusable block, `oomol-fusion-sdk` is usually the preferred integration path.

- In most cases, use it inside OOMOL Studio to build Scriptlet Blocks or Task Blocks.
- Read auth from runtime `context` instead of asking users to configure a separate third-party key.
- If you are outside Studio, you can also call the same SDK directly from your own Node.js or Python service.

Start here:

- [Fusion SDK Overview](/docs/workflow-engine/fusion-sdk-overview)
- [Fusion SDK for TypeScript](/docs/workflow-engine/fusion-sdk-typescript)
- [Fusion SDK for Python](/docs/workflow-engine/fusion-sdk-python)
