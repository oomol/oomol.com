...
>
  Start with oo-cli. Install it through the official install commands. Search,
  inspect, and run published tools first. Move into Studio when published tools
  stop short. Deliver through Cloud when it needs to keep running.
</div>
...
official install commands, managed updates, bundled skills for Codex and
