...
date: 2025-06-09
description: "OOMOL Studio 1.2.0 新增自动生成 handle、subflow 复用、批处理、网络代理，以及从 pip 切换到 poetry。"
image: /img/release/1.2.0/support-proxy.png
---
...
<ResponsiveVideo
  src="/img/release/1.2.0/support-auto-add-handle-web.mp4"
  type="video/mp4"
  controls
  muted
  autoPlay
...
<ResponsiveVideo
  src="/img/release/1.2.0/support-subflow-web.mp4"
  type="video/mp4"
  controls
  muted
  autoPlay
...
<ResponsiveVideo
  src="/img/release/1.2.0/support-batch-web.mp4"
  type="video/mp4"
  controls
  muted
  autoPlay
