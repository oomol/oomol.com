...
具体 SDK 用法可继续参考 [Fusion SDK 概览](/zh-CN/docs/workflow-engine/fusion-sdk-overview)、[Fusion SDK TypeScript 文档](/zh-CN/docs/workflow-engine/fusion-sdk-typescript) 和 [Fusion SDK Python 文档](/zh-CN/docs/workflow-engine/fusion-sdk-python)。
