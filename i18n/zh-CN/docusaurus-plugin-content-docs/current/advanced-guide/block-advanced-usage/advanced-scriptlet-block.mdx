...
你可以在代码中调用 [nodejs 预览 API](/zh-CN/docs/workflow-engine/nodejs-sdk-api#3-contextpreview-types) 或 [python 预览 API](/zh-CN/docs/workflow-engine/python-sdk-api#3-contextpreview-%E7%B1%BB%E5%9E%8B) 来观察多种类型的数据。
