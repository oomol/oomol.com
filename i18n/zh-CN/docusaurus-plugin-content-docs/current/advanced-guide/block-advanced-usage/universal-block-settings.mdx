...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/node-menu.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/node-menu.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/node-run-button.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/node-run-button.png"
    ),
...
在任意节点执行成功之后，除了类型为[变量](/zh-CN/docs/advanced-guide/block-advanced-usage/universal-block-settings#变量)的接口以外，所有节点的输出接口都会保留上一次执行的输出值，这样下游节点在选择执行的时候就会自动采用缓存值，不会触发上游节点的运行。
...
- 共享区块
  ...
  拷贝只会复制一份共享区块的引用到工作流内作为新的节点，两个节点指向的区块是同一个，代码也是同一份，因此对共享区块进行[配置](/zh-CN/docs/advanced-guide/block-advanced-usage/universal-block-settings#区块配置)会同时影响两个节点。
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/node-base-config.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/node-base-config.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/node-config-description.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/node-config-description.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/node-ignore.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/node-ignore.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/node-ignore-flow.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/node-ignore-flow.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/node-delete.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/node-delete.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-config-executor.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-config-executor.png"
    ),
...
参考 [nodejs 模板](/zh-CN/docs/workflow-engine/nodejs-sdk-api#21-scriptlet-%E6%A8%A1%E6%9D%BF) 以及 [python 模板](/zh-CN/docs/workflow-engine/python-sdk-api#21-scriptlet-%E6%A8%A1%E6%9D%BF)
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-null.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-null.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-custom-type.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-custom-type.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-any.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-any.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-string.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-string.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-var.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-var.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-path.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-path.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-secret.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-secret.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-bool.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-bool.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-int.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-int.png"
    ),
...
选择颜色类型后可以在数据输入栏中使用颜色选择控件，在子配置项中我们提供了 `HEX8` / `HSV` / `RGB` 三种格式的颜色选择。

<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-color.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-color.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-text.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-text.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-dict.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-dict.png"
    ),
...
<Image
  sources={{
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-array.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-array.png"
    ),
...
<Image
  sources={{
    ...
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-single-select.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-single-select.png"
    ),
...
<Image
  sources={{
    ...
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-multi-select.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-multi-select.png"
    ),
...
<Image
  sources={{
    ...
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-date.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-date.png"
    ),
...
<Image
  sources={{
    ...
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-binary.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-binary.png"
    ),
...
<Image
  sources={{
    ...
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-null.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-null.png"
    ),
...
<Image
  sources={{
    ...
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-combine.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-combine.png"
    ),
...
<Image
  sources={{
    ...
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-LLM.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-LLM.png"
    ),
...
<Image
  sources={{
    ...
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-LLM-model.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-LLM-model.png"
    ),
...
<Image
  sources={{
    ...
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-LLM-message.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-LLM-message.png"
    ),
...
<Image
  sources={{
    ...
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-LLM-return.png"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-config-type-LLM-return.png"
    ),
...
<Image
  sources={{
    ...
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-quick-create-node.gif"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-quick-create-node.gif"
    ),
...
<Image
  sources={{
    ...
    light: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-order.gif"
    ),
    dark: useBaseUrl(
      "/img/docs/cn/advanced-guide/advanced-block-usage/block-handle-order.gif"
    ),
