...
关于小脚本的更多介绍请参考[通用区块设置](/zh-CN/docs/advanced-guide/universal-block-settings)和[小脚本进阶用法](/zh-CN/docs/advanced-guide/advanced-scriptlet-block)。
...
关于任务区块的更多介绍请参考[通用区块设置](/zh-CN/docs/advanced-guide/universal-block-settings)和[任务区块进阶用法](/zh-CN/docs/advanced-guide/advanced-task-block)。
...
关于子流期刊的更多介绍请参考[通用区块设置](/zh-CN/docs/advanced-guide/universal-block-settings)和[子流区块进阶用法](/zh-CN/docs/advanced-guide/advanced-subflow-block)。
