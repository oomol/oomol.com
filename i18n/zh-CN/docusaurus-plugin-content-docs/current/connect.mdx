...
1. ��开 [https://connect.oomol.com/applet](https://connect.oomol.com/applet)
2. 登录您的 OOMOL 账户
3. 选择您想要使用的应用或功能
...
### Q: 支持哪些 OOMOL Packages？
A: 支持 OOMOL 社区的所有 Packages，您可以在 [OOMOL Packages](https://oomol.com/packages) 浏览完整列表。
