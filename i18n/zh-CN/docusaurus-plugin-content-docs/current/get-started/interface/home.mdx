...
左下角显示的是当前账户的 [OOMOL 点数](/zh-CN/docs/get-started/metering-and-billing) 信息，你可以看到点数使用情况、剩余数量，以及进入点数管理页面。

:::info
[OOMOL 点数](/zh-CN/docs/get-started/metering-and-billing)主要用于代码补全、AI Agent、AI API 等能力的调用。

由于使用的 AI 来自不同渠道，所以我们使用统一的点数来计量。

关于点数价格，可以参考 [价格页面](/zh-CN/pricing)。
:::
