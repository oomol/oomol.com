  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor="var(--oomol-text-primary)" stopOpacity="0" />
          <stop offset="1" stopColor="var(--oomol-text-secondary)" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="var(--oomol-text-primary)" />
          <stop offset="0.578125" stopColor="var(--oomol-primary)" />
          <stop offset="1" stopColor="var(--oomol-primary)" />
        </linearGradient>
        <linearGradient
        ...
        >
          <stop stopColor="var(--oomol-text-primary)" />
          <stop offset="0.157789" stopColor="var(--oomol-primary)" />
          <stop offset="1" stopColor="var(--oomol-primary)" />
        </radialGradient>
