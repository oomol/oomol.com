...
import styles from "./PixelBlast.module.scss";

/* global ResizeObserver, cancelAnimationFrame, requestAnimationFrame, PointerEvent */
          ...
          composer.passes.forEach(p => {
            ...
            if (effs)
              effs.forEach((eff: Effect) => {
                ...
                const u = effectUniforms?.get("uTime");
