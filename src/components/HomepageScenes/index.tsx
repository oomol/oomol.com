...
const scenesData: ScenesDataType[] = [
  ...
  },
  {
    ...
    title: translate({ message: "HOME.Scenes.dataScience.title" }),
    inner: translate({ message: "HOME.Scenes.dataScience.inner" }),
  ...
  },
  {
    ...
    title: translate({ message: "HOME.Scenes.multimedia.title" }),
    inner: translate({ message: "HOME.Scenes.multimedia.inner" }),
  ...
  },
  {
    ...
    title: translate({ message: "HOME.Scenes.aiAgent.title" }),
    inner: translate({ message: "HOME.Scenes.aiAgent.inner" }),
  ...
  },
  {
    ...
    title: translate({ message: "HOME.Scenes.apiPublish.title" }),
    inner: translate({ message: "HOME.Scenes.apiPublish.inner" }),
  ...
  },
  {
    ...
    title: translate({ message: "HOME.Scenes.enterprise.title" }),
    inner: translate({ message: "HOME.Scenes.enterprise.inner" }),
    icon: "i-codicon-server-process",
